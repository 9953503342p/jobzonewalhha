...
import InternshipGridPage from "../app/pannels/public-user/components/Internship/Internship-grid";
import InternshipListPage from "../app/pannels/public-user/components/Internship/Internship-list";
import CoursesPage from "../app/pannels/public-user/components/pages/Courses";
import EmpDashboardPage from "../app/pannels/admin/components/course-dashboard";
import EmpManageJobsPage from "../app/pannels/admin/components/courses/courses-manage-job";
import EmpPostAJobPage from "../app/pannels/admin/components/courses/courses-post-a-course";
...
function PublicUserRoutes() {
    return (
        <Routes>
            ...
            <Route path={publicUser.pages.Courses} element={<CoursesPage />} />
            ...
            <Route path={publicUser.Internship.GRID} element={<InternshipGridPage />} />
            <Route path={publicUser.Internship.LIST} element={<InternshipListPage />} />
            ...
            {/*Admin panel */}
            <Route path={publicUser.Admin.DASHBOARD} element={<EmpDashboardPage />} />
            <Route path={publicUser.Admin.MANAGE_Courses} element={<EmpManageJobsPage />} />
            <Route path={publicUser.Admin.POST_A_Courses} element={<EmpPostAJobPage />} />
        </Routes>
    )
}
